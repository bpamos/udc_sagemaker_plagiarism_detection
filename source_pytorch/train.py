...
def model_fn(model_dir):
    ...
    model = BinaryClassifier(model_info['input_features'], model_info['hidden_dim1'], model_info['hidden_dim2'], model_info['output_dim'])
...
if __name__ == '__main__':
    ...
    model = BinaryClassifier(args.input_features, args.hidden_dim1, args.hidden_dim2, args.output_dim).to(device)
